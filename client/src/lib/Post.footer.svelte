<script lang="ts">
  ...
  appService.user.subscribe((value) => {
    localUser = value;
    if (localUser) userInteractionMessage = "Like & comment";
    else userInteractionMessage = "Sign in to like & comment";
  });
      ...
      <div class="bylines">
        <div class="byline_likes">
          <span
            on:click={upVote}
            on:keydown={upVote}
            class:disabled={!localUser}
            title={userInteractionMessage}
          >
            <svg
              class="likes_icon"
              version="1.1"
          ...
          <span class="byline_comments">
            ...
            <span class="comments_text"
              >{post.header.commentCount} Comments</span
            >
          </span>
        </div>
