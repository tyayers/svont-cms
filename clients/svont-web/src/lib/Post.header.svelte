<script lang="ts">
  ...
  function shareOnTwitter() {
    //var url = 'https://twitter.com/intent/tweet?url=' + window.location.href + '&via=svontcms&text=Check%20this%20out:';
    var url = 'https://twitter.com/intent/tweet?url=' + window.location.href + '&text=Check%20this%20out:';
  ...
  function shareOnFacebook() {
    var url = 'https://www.facebook.com/sharer/sharer.php?u=' + window.location.href + '&t=Check%20this%20out:';
    ...
    <div class="frame">
      ...
      <div class="bylines">
        ...
        <div class="byline_right">
          <a href="" title="Share on Twitter" on:click={shareOnTwitter} on:keypress={shareOnTwitter}>
          ...
          <a href="" title="Share on Facebook" on:click={shareOnFacebook} on:keypress={shareOnFacebook}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
              ><path
          ...
          <a href="" title="Share on LinkedIn" on:click={shareOnLinkedIn} on:keypress={shareOnLinkedIn}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
              ><path
          ...
          <a href="" title="Copy a link" on:click={shareLink} on:keypress={shareLink}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
              ><path
                fill-rule="evenodd"
                clip-rule="evenodd"
            ...
            >
            <input type="text" id="linkInput" value={window.location.href} style="display: none"/>
          </a>
